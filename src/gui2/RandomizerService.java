...
public class RandomizerService extends Service<Void> {
  ...
  private static final ImmutableList<String> PREY_SOULS_ENEMIES_DEPENDENCIES = ImmutableList.of(
      ...
      ZipHelper.PHANTOM_SOLAR_PROJECTILE_ROUND, ZipHelper.CHARACTER_ATTACHMENT_EFFECTS, ZipHelper.ARK_META_TAGS,
      ZipHelper.LORE_LIBRARY, ZipHelper.NEUROMOD_RESEARCH_TOPICS, ZipHelper.AI_TREE_ABSOLUTE_NIGHTMARE, ZipHelper.ZOMBIE_CDF);
  private static final ImmutableList<String> PREY_SOULS_ENEMIES_DIR_DEPENDENCIES = ImmutableList.of(
      ZipHelper.ANIMATIONS_ADB_DIR, ZipHelper.PHANTOM_SKINS_DIR, ZipHelper.WEAVER_SKINS_DIR);
