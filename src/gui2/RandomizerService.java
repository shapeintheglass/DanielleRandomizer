...
public class RandomizerService extends Service<Void> {
  ...
  private static final ImmutableList<String> PLAYER_MODEL_RANDOMIZATION_DEPENDENCIES =
      ImmutableList.of(ZipHelper.PLAYER_TYPHON_SKIN_INNER, ZipHelper.PLAYER_TYPHON_SKIN_OUTER,
          ZipHelper.PLAYER_TYPHON_SKIN_SCROLL);
  ...
  private static final ImmutableList<String> PREY_SOULS_GUNS_DEPENDENCIES = ImmutableList.of(
      ...
      ZipHelper.ARK_ITEMS_XML, ZipHelper.PARTICLES_CHARACTERS,
      ZipHelper.ANIMATIONS_ARK_PLAYER_DATABASE_3P, ZipHelper.ANIMATIONS_DUAL_WRENCH_PLAYER_1P,
      ZipHelper.ANIMATIONS_ARK_ITEM_TAGS, ZipHelper.ANIMATIONS_ARK_PLAYER_DATABASE_1P,
      ZipHelper.ANIMATIONS_ARK_UNSILENCED_PISTOL_PLAYER_1P,
      ZipHelper.ANIMATIONS_ARK_UNSILENCED_PISTOL_WEAPON,
      ZipHelper.ANIMATIONS_ARK_SLOW_SHOTGUN_PLAYER_1P, ZipHelper.ANIMATIONS_ARK_SLOW_SHOTGUN_WEAPON,
      ZipHelper.PLAYER_CDF, ZipHelper.ANIMATIONS_ARK_DUAL_PISTOL_PLAYER_1P,
      ZipHelper.ANIMATIONS_ARK_DUAL_PISTOL_WEAPON, ZipHelper.DUAL_PISTOL_CDF,
      ZipHelper.PARTICLES_PLAYER_WEAPONS, ZipHelper.PROJECTILE_POOLS);
  ...
  private static final ImmutableList<String> PREY_SOULS_TURRETS_DEPENDENCIES =
      ImmutableList.of(ZipHelper.ANIMATIONS_ARK_FLAMETHROWER_TURRET,
          ZipHelper.ANIMATIONS_ARK_LASER_TURRET, ZipHelper.SIGNAL_SYSTEM_PACKAGES,
          ZipHelper.ARK_PROJECTILES_XML, ZipHelper.ARK_ROBOTS_XML, ZipHelper.PARTICLES_CHARACTERS,
          ZipHelper.PARTICLES_PLAYER_WEAPONS, ZipHelper.PROJECTILE_POOLS);

  private static final ImmutableList<String> MORE_GUNS_DEPENDENCIES =
      ImmutableList.of(ZipHelper.ARK_PICKUPS_XML, ZipHelper.ARK_PROJECTILES_XML,
          ZipHelper.ARK_ITEMS_XML, ZipHelper.SIGNAL_SYSTEM_PACKAGES, ZipHelper.PROJECTILE_POOLS);
  ...
  private static final ImmutableList<String> PREY_SOULS_ENEMIES_DEPENDENCIES =
      ImmutableList.of(ZipHelper.AI_SIGNAL_RECEIVER_THERMAL_MIMIC, ZipHelper.NPC_ABILITIES,
          ZipHelper.NPC_ABILITY_CONTEXT_PROFILES, ZipHelper.NPC_ABILITY_CONTEXTS,
          ZipHelper.NPC_GAME_EFFECTS, ZipHelper.SIGNAL_SYSTEM_MODIFIERS,
  ...
  private String executeRandomization(Settings currentSettings, Path tempDir, Path tempLevelDir,
    ...
    if (currentSettings.getCheatSettings()
      ...
      customSpawnGenerator.setSpawn(currentSettings.getCheatSettings()
          .getCustomSpawnLocation(), zipHelper, seed);
