 ...
 * 
 * Original state --> New State Locked --> Locked= OK Not Locked --> Not Locked = OK Locked --> Not
 * Locked = OK Not Locked --> Locked = Iffy
 */
public class LockedObjectRule implements Rule {
  ...
  private static final ImmutableSet<String> HACKABLE_ARCHETYPES =
      ImmutableSet.of("ArkGameplayObjects.Keypad.Keypad_Default",
          "ArkGameplayObjects.InteractiveScreens.Workstation",
          "ArkGameplayObjects.InteractiveScreens.SecurityStation",
          "ArkGameplayObjects.Keypad.Keypad_NoFrame",
   ...
   * "ArkGameplayObjects.Door.Door_Sliding_Double_Default",
   * "ArkGameplayObjects.Door.Door_Sliding_Double_Large",
   * "ArkGameplayObjects.Door.Door_SecurityBooth_A",
   * "ArkGameplayObjects.Door.Door_Standard_A_Dmg_Open",
   * "ArkGameplayObjects.Door.Door_Standard_A_Dmg_Closed",
   * "ArkGameplayObjects.Door.Door_Standard_A_Large_Dmg_Opened",
   * "ArkGameplayObjects.Door.Door_Standard_A_Large_Dmg_Closed",
   * "ArkGameplayObjects.Door.DoorFrame_NeoDeco_A_Large",
   * "ArkGameplayObjects.Door.DoorFrame_NeoDeco_A_Small",
   * "ArkGameplayObjects.Door.Turnstile_Securty_A", "ArkGameplayObjects.Door.Door_Greenhouse_Side",
   * "ArkGameplayObjects.Door.Door_Greenhouse_Front", "ArkGameplayObjects.Door.BlastDoor_Medium",
   * "ArkGameplayObjects.Door.BlastDoor_Small", "ArkGameplayObjects.Door.BlastDoor_Large",
   * "ArkGameplayObjects.Door.Door_CargoContainer",
   * "ArkGameplayObjects.Door.BlastDoor_Medium_NoAuto",
   * "ArkGameplayObjects.Door.DoorFrame_Lab_A_Small",
  ...
  public LockedObjectRule(float lockedRatio) {
  ...
  public boolean trigger(Element e, Random r, String filename) {
    ...
    // boolean hasKeycode =
    // !e.getChild("Properties2").getAttributeValue("keycode_UnlockCode").isEmpty();
    return guid != null && archetype != null && !GUIDS_NOT_TO_RANDOMIZE.contains(guid)
        && HACKABLE_ARCHETYPES.contains(archetype);
  }
