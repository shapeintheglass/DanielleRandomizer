...
public class PlayerModelRandomizer extends BaseRandomizer {
  ...
  private static final ImmutableList<String> PLAYER_FILES = ImmutableList.of(ZipHelper.PLAYER_CDF,
      ZipHelper.PLAYER_FEMALE_PAJAMA_CDF, ZipHelper.PLAYER_MALE_PAJAMA_CDF, ZipHelper.PLAYER_ALIEN_CDF,
      ZipHelper.PLAYER_FEMALE_CDF);

  private static final ImmutableSet<String> ARMS = ImmutableSet.of("arms", "pajama_arms", "base_arms", "player_CDF");
  ...
  private static final String PAJAMA_FEMALE_ARMS_MTL = "objects/characters/player/female/player1p_female_02_arms.mtl";
  ...
  private static final ImmutableMap<BodyType, String> BODY_TYPE_TO_ARMS_SKIN = new ImmutableMap.Builder<BodyType, String>()
  ...
  private static final ImmutableMap<BodyType, String> BODY_TYPE_TO_LEGS_SKIN = new ImmutableMap.Builder<BodyType, String>()
      .put(BodyType.Cosmonaut, GENERIC_SUIT_SKIN)
  ...
  private static final ImmutableMap<BodyType, String> BODY_TYPE_TO_LEGS_MTL = new ImmutableMap.Builder<BodyType, String>()
      .put(BodyType.Cosmonaut, GENERIC_SUIT_MTL)
