...
public class AddEntityHelper {
  ...
  public static void addEntities(Element objects, String filename, Settings settings, ZipHelper zipHelper) {
    if (settings.getExpSettings().getStartSelfDestruct() && filename.equals("research/simulationlabs")) {
    ...
    if (settings.getExpSettings().getZeroGravityEverywhere() && !filename.equals("station/exterior")) {
