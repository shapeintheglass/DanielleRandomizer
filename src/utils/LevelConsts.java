...
public class LevelConsts {
  ...
  public static final List<String> DO_NOT_TOUCH_ITEM_TAGS =
      Lists.newArrayList("Data", "MissionItems", "BigNullwaveTransmitterFabPlan",
          ...
          "research/simulationlabs;Weapons.Wrench1", "MedKit_Wall_Mounted", "ArkContainer");
  ...
  public static final List<String> DO_NOT_OUTPUT_ITEM_TAGS =
      Lists.newArrayList("Architecture", "Gameplay", "Industrial", "Space", "Light_Fixtures",
          ...
          "OperatorGrenade", "ShotgunPreorderFabPlan", "ArkContainer");
  ...
  public static final List<String> KILLABLE_NPC_ARCHETYPES =
      Lists.newArrayList("ArkNightmare", "ArkPoltergeist", "Mimics.EliteMimic", "Mimics.Mimic",
          "Named Phantoms.ArkBeta_ArgentenoPero", "Named Phantoms.ArkBeta_CliveLawrence",
          "Named Phantoms.ArkBeta_CrispinBoyer", "Named Phantoms.ArkBeta_EnochKouneva",
          "Named Phantoms.ArkBeta_GarfieldLangley", "Named Phantoms.ArkBeta_HelenCombs",
          "Named Phantoms.ArkBeta_IvyPark", "Named Phantoms.ArkBeta_JeanFaure",
          ...
          "Named Phantoms.Etheric_RandolfHutchinson", "Overseers.Technopath", "Overseers.Telepath",
          "Overseers.Weaver", "Phantoms.BasePhantom", "Phantoms.EthericDoppelganger",
          "Phantoms.EthericPhantom", "Phantoms.ThermalPhantom", "Phantoms.VoltaicPhantom");
