...
public class LevelConsts {
  ...
  public static final List<String> DO_NOT_OUTPUT_NPC_TAGS = Lists.newArrayList("Tentacle_Large_Guard",
      "Tentacle_Medium_Guard", "Tentacle_Small_Guard", "FakeTechnopath", "Cystoid_IgnorePlayer");
  ...
  public static final ImmutableMap<String, String> UNLOCK_LIFT_TOKENS = ImmutableMap.of(
      "Lobby.TechnoPathDeadForElevator", "true", "Lobby.LiftAtTop", "true");
}
