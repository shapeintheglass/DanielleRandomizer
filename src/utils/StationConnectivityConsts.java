...
public final class StationConnectivityConsts {
  ...
  public static enum Level {
    NEUROMOD_DIVISION, LOBBY, HARDWARE_LABS, PSYCHOTRONICS, SHUTTLE_BAY, GUTS, ARBORETUM, CREW_QUARTERS, DEEP_STORAGE,
    BRIDGE, CARGO_BAY, LIFE_SUPPORT, POWER_PLANT
  }

  public static enum Door {
    NEUROMOD_DIVISION_LOBBY_EXIT, LOBBY_NEUROMOD_DIVISION_EXIT, LOBBY_HARDWARE_LABS_EXIT, LOBBY_SHUTTLE_BAY_EXIT,
    LOBBY_PSYCHOTRONICS_EXIT, LOBBY_ARBORETUM_EXIT, LOBBY_LIFE_SUPPORT_EXIT, HARDWARE_LABS_LOBBY_EXIT,
    PSYCHOTRONICS_LOBBY_EXIT, PSYCHOTRONICS_GUTS_EXIT, SHUTTLE_BAY_LOBBY_EXIT, SHUTTLE_BAY_GUTS_EXIT,
    GUTS_PSYCHOTRONICS_EXIT, GUTS_SHUTTLE_BAY_EXIT, GUTS_CARGO_BAY_EXIT, GUTS_ARBORETUM_EXIT, ARBORETUM_GUTS_EXIT,
    ARBORETUM_BRIDGE_EXIT, ARBORETUM_DEEP_STORAGE_EXIT, ARBORETUM_CREW_QUARTERS_EXIT, ARBORETUM_LOBBY_EXIT,
    CREW_QUARTERS_ARBORETUM_EXIT, DEEP_STORAGE_ARBORETUM_EXIT, BRIDGE_ARBORETUM_EXIT, CARGO_BAY_GUTS_EXIT,
    CARGO_BAY_LIFE_SUPPORT_EXIT, LIFE_SUPPORT_CARGO_BAY_EXIT, LIFE_SUPPORT_LOBBY_EXIT, LIFE_SUPPORT_POWER_PLANT_EXIT,
  ...
  public static final ImmutableMap<Level, ImmutableSet<Door>> DOORS_UNLOCKED_BY_LEVEL = new ImmutableMap.Builder<Level, ImmutableSet<Door>>()
      .put(Level.ARBORETUM, ImmutableSet.of(Door.LOBBY_ARBORETUM_EXIT, Door.LOBBY_LIFE_SUPPORT_EXIT,
      ...
      .put(Level.GUTS, ImmutableSet.of(Door.SHUTTLE_BAY_GUTS_EXIT, Door.GUTS_SHUTTLE_BAY_EXIT))
      .put(Level.CREW_QUARTERS, ImmutableSet.of(Door.ARBORETUM_DEEP_STORAGE_EXIT))
      .build();

  // Map of level to level id
  public static final ImmutableBiMap<Level, String> LEVELS_TO_NAMES = new ImmutableBiMap.Builder<Level, String>().put(
      Level.ARBORETUM, "executive/arboretum")
  ...
  // Map of level to level id
  public static final ImmutableBiMap<Level, String> LEVELS_TO_IDS = new ImmutableBiMap.Builder<Level, String>().put(
      Level.ARBORETUM, "1713490239386284818")
  ...
  public static final ImmutableBiMap<Level, String> LEVELS_TO_DESTINATIONS = new ImmutableBiMap.Builder<Level, String>()
      .put(Level.ARBORETUM, "From_Arboretum")
      .put(Level.BRIDGE, "From_Bridge")
      .put(Level.CARGO_BAY, "From_CargoBay")
      .put(Level.CREW_QUARTERS, "From_CrewQuarters")
  ...
  public static final ImmutableMap<Door, String> DOORS_TO_NAMES = new ImmutableMap.Builder<Door, String>().put(
      Door.ARBORETUM_BRIDGE_EXIT, "Door.Door_LevelTransition_Default5")
      ...
      .put(Door.POWER_PLANT_LIFE_SUPPORT_EXIT, "Door.Door_LevelTransition_Default6")
  ...
  public static final ImmutableMap<Door, String> DOORS_TO_SPAWNS = new ImmutableMap.Builder<Door, String>().put(
      Door.ARBORETUM_BRIDGE_EXIT, "SpawnFromLobby2")
      ...
      .put(Door.DEEP_STORAGE_ARBORETUM_EXIT, "switch") // Why are you the way that you are, Deep Storage
  ...
  public static final ImmutableMultimap<Level, Door> LEVELS_TO_DOORS = new ImmutableMultimap.Builder<Level, Door>().put(
      Level.ARBORETUM, Door.ARBORETUM_BRIDGE_EXIT)
  ...
  public static final ImmutableBiMap<Door, Door> DEFAULT_CONNECTIVITY = new ImmutableBiMap.Builder<Door, Door>().put(
      Door.ARBORETUM_BRIDGE_EXIT, Door.BRIDGE_ARBORETUM_EXIT)
  ...
  public static final ImmutableSet<Door> SINGLE_CONNECTIONS = ImmutableSet.of(Door.BRIDGE_ARBORETUM_EXIT,
      Door.CREW_QUARTERS_ARBORETUM_EXIT, Door.DEEP_STORAGE_ARBORETUM_EXIT, Door.HARDWARE_LABS_LOBBY_EXIT,
      Door.NEUROMOD_DIVISION_LOBBY_EXIT, Door.POWER_PLANT_LIFE_SUPPORT_EXIT);
  ...
  public static final ImmutableSet<Door> LIFT_NOT_LOBBY_SIDE = ImmutableSet.of(Door.ARBORETUM_LOBBY_EXIT,
      Door.LIFE_SUPPORT_LOBBY_EXIT);
  public static final ImmutableSet<Door> APEX_LOCKED_KILL_WALL_SIDE = ImmutableSet.of(Door.LOBBY_HARDWARE_LABS_EXIT,
      Door.ARBORETUM_DEEP_STORAGE_EXIT);
  public static final ImmutableSet<Door> APEX_LOCKED_NO_KILL_WALL_SIDE = ImmutableSet.of(Door.HARDWARE_LABS_LOBBY_EXIT,
