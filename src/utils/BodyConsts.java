...
public class BodyConsts {
  ...
  public static final String LARGE_MALE_BODY_TYPE =
      "objects/characters/humans/largemale/largemale.chr";

  public static final String LARGE_MALE_ATTACHMENTS =
      "objects/characters/humans/largemale/largemale_attachments.cdf";
  public static final String MALE_ATTACHMENTS =
      "objects/characters/humans/genmale/genmale_attachments.cdf";
  public static final String FEMALE_ATTACHMENTS =
      "objects/characters/humans/genfemale/genfemale_attachments.cdf";

  public static final String[] LARGE_MALE_BODIES = {"corporate/corporate_largemalebody01"};
  public static final String[] LARGE_MALE_MTLS =
      {"corporate/corporate_largemalebody_variant", "corporate/corporate_largemalebody01"};
  ...
  public static final String[] ALEX_HAIRS =
      {"AlexLiKarl/AlexLiKarl_LargeMaleHead01_Hair01", "alexlikarl_largemalehead01_variant_hair01"};

  public static enum FemaleBody {
    CORPORATE,
    MECHANIC,
    PLUMBER,
    SCIENTIST,
  ...
  public static enum LargeMaleBody {
    ALEX,
    ALEX_VARIANT
  }

  public static enum FemaleHead {
    HEAD01,
    HEAD02,
    HEAD02_PSYCHOSCOPE,
    HEAD03,
  ...
  public static enum LargeMaleHead {
    ALEX,
    ALEX_VARIANT,
    LUKA
  }

  public static enum FemaleHair {
    HEAD01_HAIR02,
    HEAD01_HAIR03,
    HEAD01_HAIR05,
    HEAD02_HAIR02,
  ...
  public static enum LargeMaleHair {
    ALEX,
    ALEX_VARIANT,
    LUKA
  }

  public static final ImmutableSet<MaleHead> HEADS_THAT_CAN_BE_BALD =
      ImmutableSet.of(MaleHead.HEAD04, MaleHead.INGRAM, MaleHead.VOLUNTEER01, MaleHead.VOLUNTEER02,
          MaleHead.VOLUNTEER03);

  public static final ImmutableMultimap<MaleHead, MaleHair> MALE_HEAD_HAIR_COMPATIBILITY =
      new ImmutableMultimap.Builder<MaleHead, MaleHair>()
  ...
  public static final ImmutableMap<MaleHair, MaleHairType> MALE_HAIR_TO_HAIR_TYPE =
      new ImmutableMap.Builder<MaleHair, MaleHairType>()
  ...
  public static final ImmutableMultimap<FemaleHead, FemaleHair> FEMALE_HEAD_HAIR_COMPATIBILITY =
      new ImmutableMultimap.Builder<FemaleHead, FemaleHair>()
  ...
  public static final ImmutableMap<FemaleHair, FemaleHairType> FEMALE_HAIR_TO_HAIR_TYPE =
      new ImmutableMap.Builder<FemaleHair, FemaleHairType>()
  ...
  public static final ImmutableMultimap<FemaleHairType, FemaleHairColor> FEMALE_HAIR_COLOR_COMPATIBILITY =
      new ImmutableMultimap.Builder<FemaleHairType, FemaleHairColor>()
  ...
  public static final ImmutableMap<FemaleBody, String> FEMALE_BODIES_MAP =
      new ImmutableMap.Builder<FemaleBody, String>()
  ...
  public static final ImmutableMap<MaleBody, String> MALE_BODIES_MAP =
      new ImmutableMap.Builder<MaleBody, String>()
          .put(MaleBody.CORPORATE, "corporate/corporate_genmalebody01")
  ...
  public static final ImmutableMap<FemaleHead, String> FEMALE_HEADS_MAP =
      new ImmutableMap.Builder<FemaleHead, String>()
          ...
          .put(FemaleHead.DANIELLE,
              "objects/accessories/breather/breather3p/breather3p_genfemale01")
          .put(FemaleHead.HELMET, "scientist/scientist_genfemalehead01")
          .put(FemaleHead.HUSK, "husk/husk_genfemalehead01")
          .build();

  public static final ImmutableMap<MaleHead, String> MALE_HEADS_MAP =
      new ImmutableMap.Builder<MaleHead, String>().put(MaleHead.DAHL, "dahl/dahl_genmalehead01")
  ...
  public static final ImmutableMap<FemaleHair, String> FEMALE_HAIRS_MAP =
      new ImmutableMap.Builder<FemaleHair, String>()
  ...
  public static final ImmutableMap<FemaleHairColor, String> FEMALE_HAIR_COLORS_MAP =
      new ImmutableMap.Builder<FemaleHairColor, String>()
  ...
  public static final ImmutableMap<MaleHair, String> MALE_HAIRS_MAP =
      new ImmutableMap.Builder<MaleHair, String>()
          .put(MaleHair.HEAD01_HAIR01, "genmale/genmale_head01_hair01")
  ...
  public static final ImmutableMap<MaleHairColor, String> MALE_HAIR_COLORS_MAP =
      new ImmutableMap.Builder<MaleHairColor, String>()
  ...
  public static final FemaleBody[] SUPPORTED_FEMALE_BODIES =
      {FemaleBody.CORPORATE, FemaleBody.MECHANIC, FemaleBody.PLUMBER, FemaleBody.SCIENTIST,
          FemaleBody.SECURITY, FemaleBody.GLOVELESS};
  public static final Integer[] FEMALE_BODIES_WEIGHTS = {5, 5, 1, 5, 5, 1};

  public static final MaleBody[] SUPPORTED_MALE_BODIES =
      {MaleBody.CORPORATE, MaleBody.DAHL, MaleBody.LABCOAT, MaleBody.MECHANIC, MaleBody.SCIENTIST,
          MaleBody.SECURITY, MaleBody.VOLUNTEER, MaleBody.GLOVELESS};
  public static final Integer[] MALE_BODIES_WEIGHTS = {5, 1, 5, 5, 5, 5, 5, 1};

  public static final ImmutableSet<FemaleBody> ACCESSORY_COMPATIBLE_FEMALE_BODIES =
      ImmutableSet.of(FemaleBody.CORPORATE, FemaleBody.MECHANIC, FemaleBody.SCIENTIST,
          FemaleBody.SECURITY, FemaleBody.GLOVELESS);
  public static final ImmutableSet<MaleBody> ACCESSORY_COMPATIBLE_MALE_BODIES =
      ImmutableSet.of(MaleBody.CORPORATE, MaleBody.DAHL, MaleBody.MECHANIC, MaleBody.SCIENTIST,
          MaleBody.SECURITY, MaleBody.GLOVELESS);

  public static final FemaleHead[] SUPPORTED_FEMALE_HEADS =
      {FemaleHead.HEAD01, FemaleHead.HEAD02, FemaleHead.HEAD02_PSYCHOSCOPE, FemaleHead.HEAD03,
          FemaleHead.HEAD04, FemaleHead.HEAD05, FemaleHead.HEAD06, FemaleHead.MIKHAILA,
          FemaleHead.MORGAN, FemaleHead.SARA, FemaleHead.HELMET};

  public static final ImmutableSet<FemaleHead> FEMALE_HEADS_THAT_SHOULD_NOT_HAVE_BARE_HANDS =
      ImmutableSet.of(FemaleHead.SARA, FemaleHead.HEAD01, FemaleHead.HUSK);
  public static final ImmutableSet<MaleHead> MALE_HEADS_THAT_SHOULD_NOT_HAVE_BARE_HANDS =
      ImmutableSet.of(MaleHead.IGWE, MaleHead.HEAD04, MaleHead.HUSK);
  public static final ImmutableSet<FemaleBody> FEMALE_BODIES_WITH_BARE_HANDS =
      ImmutableSet.of(FemaleBody.GLOVELESS);
  public static final ImmutableSet<MaleBody> MALE_BODIES_WITH_BARE_HANDS =
      ImmutableSet.of(MaleBody.GLOVELESS, MaleBody.VOLUNTEER);

  public static final String FEMALE_HEAD_HELMET =
      "objects/accessories/breather/breather3p/breather3p_genfemale01";
  public static final String FEMALE_HEAD_HELMET_MTL =
      "objects/accessories/breather/breather3p/breather1";

  public static final MaleHead[] SUPPORTED_MALE_HEADS =
      {MaleHead.DAHL, MaleHead.CALVINO, MaleHead.IGWE, MaleHead.HEAD01, MaleHead.HEAD01_PSYCHOSCOPE,
          MaleHead.HEAD01_PSYCHO, MaleHead.HEAD02, MaleHead.HEAD03, MaleHead.HEAD03_PSYCHOSCOPE,
          MaleHead.HEAD04, MaleHead.HEAD05, MaleHead.HEAD06, MaleHead.MORGAN, MaleHead.VOLUNTEER01,
          MaleHead.VOLUNTEER02, MaleHead.VOLUNTEER03, MaleHead.HELMET};

  // Used to make sure that "complete" heads do not have hair
  // TODO: Add husk heads?
  public static final ImmutableSet<FemaleHead> FEMALE_HEADS_THAT_SHOULD_NOT_HAVE_HAIR =
      ImmutableSet.of(FemaleHead.HEAD02_PSYCHOSCOPE, FemaleHead.HELMET);

  public static final ImmutableSet<MaleHead> MALE_HEADS_THAT_SHOULD_NOT_HAVE_HAIR =
      ImmutableSet.of(MaleHead.HEAD01_PSYCHOSCOPE, MaleHead.HEAD01_PSYCHO,
          MaleHead.HEAD01_PSYCHOSCOPE, MaleHead.HELMET);

  // TODO: Bellamy's labcoat seems to be broken, female limbs as well
  public static final String MALE_LAB_COAT_LIMBS =
  ...
  public static final String FEMALE_LAB_COAT_LIMBS =
  ...
  public static final String[] ACCESSORIES_FEMALE_MTL =
      {"objects/accessories/propulsionpack/propulsionpack_3p_01"};
  public static final String[] ACCESSORIES_MALE =
      {"objects/characters/humans/dahl/dahl_genmalebackpack01.skin",
          "objects/accessories/propulsionpack/propulsionpack3p_genmale01"};
  public static final String[] ACCESSORIES_MALE_MTL =
      {"objects/characters/humans/dahl/dahl_genmalebody01.mtl",
          "objects/accessories/propulsionpack/propulsionpack_3p_01"};
}
