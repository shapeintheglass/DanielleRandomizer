...
public class TagHelper {
  ...
  // All valid tags
  public static final String[] ITEM_TAGS = { "JUNK", "SPARE_PARTS", "FOOD",
      "AMMO", "GRENADE", "PSI_HYPO", "MEDKIT", "CHIPSET_SUIT", "CHIPSET_SCOPE",
      "WEAPON_KIT", "FAB_PLAN", "WEAPON", "NEUROMOD", "PHARMA",
      "SUIT_REPAIR_KIT", "ITEM_OTHER" };
  public static final String[] ITEM_GROUP_TAGS = { "HEALING", "CHIPSET" };
  public static final String[] ENEMY_TAGS = { "BASE_MIMIC", "GREATER_MIMIC",
      "POLTERGEIST", "CYSTOID", "CYSTOID_NEST", "PHANTOM_ETHERIC",
      "PHANTOM_VOLTAIC", "PHANTOM_THERMAL", "WEAVER", "TECHNOPATH", "TELEPATH",
      "PHANTOM_NAMED", "NIGHTMARE", "TENTACLE", "TYPHON_OTHER", "PHANTOM_BASE" };
  public static final String[] ENEMY_GROUP_TAGS = { "MIMIC", "PHANTOM" };
  public static final String[] ROBOT_TAGS = { "ENG_OP", "MED_OP", "SCI_OP",
      "MIL_OP", "TURRET", "ENG_OP_CORR", "MED_OP_CORR", "SCI_OP_CORR",
      "MIL_OP_CORR", "ROBOT_OTHER" };
  public static final String[] ROBOT_GROUP_TAGS = { "CORRUPTED",
      "FRIENDLY_ROBOT" };
  public static final String[] GAMEPLAY_TAGS = { "RECYCLER", "FABRICATOR",
      "O2_STATION" };
  ...
  public static final String[] SUPER_TYPE = { "PICKUP", "PHYSICS_PROP",
      "TYPHON", "HUMAN", "ROBOT", "PROJECTILE", "SUPER_TYPE_OTHER" };
  public static final String[][] TAG_LIST_LIST = { ITEM_TAGS, ITEM_GROUP_TAGS,
      ENEMY_TAGS, ENEMY_GROUP_TAGS, ROBOT_TAGS, ROBOT_GROUP_TAGS,
      GAMEPLAY_TAGS, OTHER_TAG, ENTITY_MISSING_TAG, GLOBAL_TAG, SUPER_TYPE };
